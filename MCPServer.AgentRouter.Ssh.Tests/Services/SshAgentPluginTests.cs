...
using MCPServer.AgentRouter.Ssh.Tests.Testing;
using MCPServer.Tools.Ssh.Interfaces;
using MCPServer.Tools.Ssh.Models;
using Xunit;

namespace MCPServer.AgentRouter.Ssh.Tests.Services;

public sealed class SshAgentPluginTests
{
    [Fact]
    public void AgentRouterSshModule_Registers_Generic_Agent_Plugin()
    {
    ...
    private static IContainer BuildContainer()
    {
        ...
        builder.RegisterType<FakeSshAgentRuntime>()
            ...
            .As<ISshAgentRuntime>()
            .SingleInstance();
        builder.RegisterModule(new AgentRouterSshModule());
