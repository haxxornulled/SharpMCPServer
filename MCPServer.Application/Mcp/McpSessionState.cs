...
public sealed class McpSessionState : IMcpSessionState
{
    ...
    public void ResetSession()
    {
        ...
        Volatile.Write(ref _negotiatedProtocolVersion, default);
        Volatile.Write(ref _clientInfo, default);
        Volatile.Write(ref _clientCapabilities, McpClientCapabilityState.Empty);
        Volatile.Write(ref _initializeResponseSent, 0);
        Volatile.Write(ref _initializedNotificationReceived, 0);
        Volatile.Write(ref _rootsListRevision, 0);
    }
}
