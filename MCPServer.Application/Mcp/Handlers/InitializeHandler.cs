    ...
    public ValueTask<Fin<JsonElement>> HandleAsync(JsonElement? parameters, CancellationToken cancellationToken)
    {
        ...
        var result = new InitializeResult
        {
            ...
            Capabilities = new McpServerCapabilities
            {
                ...
                {
                    List = McpJsonElements.EmptyObject,
                    Cancel = McpJsonElements.EmptyObject,
                    Requests = new McpTaskRequestsCapability
                    {
                        ToolsCall = McpJsonElements.EmptyObject
                    }
                }
            },
            ...
            Instructions = "MCP 2025-11-25 stdio server with tools, resources, prompts, completions, logging, resource subscriptions, and baseline task handlers."
        };
