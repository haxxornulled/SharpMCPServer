...
public sealed class McpDispatcherSmokeTests
{
    ...
    public async Task Initialize_Stores_Client_Capabilities()
    {
        ...
        Assert.True(sessionState.ClientCapabilities.ElicitationSupportsForm);
        Assert.True(sessionState.ClientCapabilities.ElicitationSupportsUrl);
        Assert.True(sessionState.ClientCapabilities.SupportsTasks);
        Assert.True(sessionState.ClientCapabilities.TasksSupportsList);
        Assert.True(sessionState.ClientCapabilities.TasksSupportsCancel);
        Assert.True(sessionState.ClientCapabilities.TasksSupportsSamplingCreateMessage);
        Assert.True(sessionState.ClientCapabilities.TasksSupportsElicitationCreate);
    }
